		...
		if(mysql_num_rows($resultat)>0){
			...
			for($i=0;$i<(mysql_num_rows($resultat));$i=$i+1){
				...
				if($_SESSION['language_Vigne']=="FR"){
					$MOR = new Morphologique($dico['CodeAmpelo'],$dico['CodeOIV'],$dico['LibelleDescripFRA'],$dico['LibelleCritereFRA'],$dico['CaractereOIV'],$dico['CodeAmpelo'],
											$DAO->nomAcc($dico['CodeIntro']),$dico['CodeAcc'],$dico['LibelleDescripFRA'],$dico['CodeOIV'],$dico['LibelleCritereFRA'],$dico['CaractereOIV'],
											$DAO->Personne($dico['CodePersonne']),$DAO->Partenaire($dico['CodePartenaire']),$dico['CodePartenaire'],$dico['JourExpe'],$dico['MoisExpe'],$dico['AnneeExpe'],
											$dico['LieuExpe'],$DAO->site($dico['CodeSite']),$dico['CodeSite'],$dico['CodeEmplacemExpe']);
				}
				if($_SESSION['language_Vigne']=="EN"){
					$MOR = new Morphologique($dico['CodeAmpelo'],$dico['CodeOIV'],$dico['LibelleDescripENG'],$dico['LibelleCritereENG'],$dico['CaractereOIV'],$dico['CodeAmpelo'],
											$DAO->nomAcc($dico['CodeIntro']),$dico['CodeAcc'],$dico['LibelleDescripENG'],$dico['CodeOIV'],$dico['LibelleCritereENG'],$dico['CaractereOIV'],
											$DAO->Personne($dico['CodePersonne']),$DAO->Partenaire($dico['CodePartenaire']),$dico['CodePartenaire'],$dico['JourExpe'],$dico['MoisExpe'],$dico['AnneeExpe'],
											$dico['LieuExpe'],$DAO->site($dico['CodeSite']),$dico['CodeSite'],$dico['CodeEmplacemExpe']);
				}
	...
	public function chargeContentBibliographie($sql_limite,$sql_total,$page,$pagesize,$langue,$sql_possible){
		...
		if(mysql_num_rows($resultat_bibliographie)>0){
			...
			for($j=0;$j<(mysql_num_rows($resultat_bibliographie));$j=$j+1){
				...
				$BI = new Bibliograhpie($dico['CodeCit'],$dico['CodeVar'],$dico['Title'],$dico['Author'],$dico['Year'],$dico['PagesCitation'],$dico['VolumeCitation'],$DAO->nomAcc($dico['CodeIntro']),$DAO->nomVar($dico['CodeVar']),$dico['CodeIntro'],$dico['CodeVar'],$dico['TypeDoc'],$dico['Edition'],$dico['Publisher'],$dico['PlacePublished'],$dico['ISBN'],$dico['Language'],$dico['NumberOfVolumes'],$dico['PagesDoc'],$dico['CallNumber'],$dico['AuteurCitation'],$dico['NomVigneCite']);

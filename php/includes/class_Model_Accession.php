...
class Accession {
    ...
    public function getCodeIntro() {
        return $this->CodeIntro;
    }

    public function getNomIntro() {
    ...
    public function getPaysProvenance() {
        return $this->PaysProvenance;
    }

    public function getcommuneProvnance() {
        return $this->communeProvnance;
    }
    ...
    public function getCodePartenaireIntro() {
        return $this->CodePartenaireIntro;
    }

    public function getCouleurPe() {
        return $this->CouleurPe;
    }

    public function getCouleurPu() {
        return $this->CouleurPu;
    }

    public function getPepins() {
        return $this->Pepins;
    }
    ...
    public function getAdressProvenance() {
        return $this->AdressProvenance;
    }

    public function getSiteProvenance() {
        return $this->SiteProvenance;
    }

    public function getCodePartenaire() {
        return $this->CodePartenaire;
    }

    public function getUniteIntro() {
        return $this->UniteIntro;
    }
    ...
    public function getProDCollecteur() {
        return $this->ProDCollecteur;
    }

    public function getProDTypeCollecteur() {
        return $this->ProDTypeCollecteur;
    }

    public function getProDcontientProvenance() {
        return $this->ProDcontientProvenance;
    }

    public function getProDCommuneProvenance() {
        return $this->ProDCommuneProvenance;
    }

    public function getProDCodPostProvenance() {
        return $this->ProDCodPostProvenance;
    }

    public function getProDSiteProvenance() {
        return $this->ProDSiteProvenance;
    }

    public function getProDAdresProvenance() {
        return $this->ProDAdresProvenance;
    }

    public function getProDProprietProvenance() {
        return $this->ProDProprietProvenance;
    }

    public function getProDParcelleProvenance() {
        return $this->ProDParcelleProvenance;
    }

    public function getProDTypeParcelleProvenance() {
        return $this->ProDTypeParcelleProvenance;
    }

    public function getProDRangProvenance() {
        return $this->ProDRangProvenance;
    }

    public function getProDSoucheProvenance() {
        return $this->ProDSoucheProvenance;
    }

    public function getProDSoucheTheoriqueProvenance() {
        return $this->ProDSoucheTheoriqueProvenance;
    }

    public function getProDPaysProvenance() {
        return $this->ProDPaysProvenance;
    }

    public function getProDRegionProvenance() {
        return $this->ProDRegionProvenance;
    }

    public function getProDDepartProvenance() {
        return $this->ProDDepartProvenance;
    }

    public function getProDLatitude() {
        return $this->ProDLatitude;
    }

    public function getProDLongitude() {
        return $this->ProDLongitude;
    }

    public function getProDAltitude() {
        return $this->ProDAltitude;
    }

    public function getProDJour() {
        return $this->ProDJour;
    }

    public function getProDMois() {
        return $this->ProDMois;
    }

    public function getProDAnnee() {
        return $this->ProDAnnee;
    }

    public function getProDCodeIntroPorvenance() {
        return $this->ProDCodeIntroPorvenance;
    }

    public function getProDCodeEntree() {
        return $this->ProDCodeEntree;
    }

    public function getProDReIntroduit() {
        return $this->ProDReIntroduit;
    }

    public function getProDIssuTraitement() {
        return $this->ProDIssuTraitement;
    }

    public function getProDColoneTraite() {
        return $this->ProDColoneTraite;
    }

    public function getProDRemarquesProvenance() {
        return $this->ProDRemarquesProvenance;
    }

    public function getProACollecteur() {
        return $this->ProACollecteur;
    }

    public function getProATypeCollecteur() {
        return $this->ProATypeCollecteur;
    }

    public function getProAContinentProvenance() {
        return $this->ProAContinentProvenance;
    }

    public function getProACommuneProvenance() {
        return $this->ProACommuneProvenance;
    }

    public function getProACodPostProvenance() {
        return $this->ProACodPostProvenance;
    }

    public function getProASiteProvenance() {
        return $this->ProASiteProvenance;
    }

    public function getProAAdresProvenance() {
        return $this->ProAAdresProvenance;
    }

    public function getProAProprietProvenance() {
        return $this->ProAProprietProvenance;
    }

    public function getProAParcelleProvenance() {
        return $this->ProAParcelleProvenance;
    }

    public function getProATypeParcelleProvenance() {
        return $this->ProATypeParcelleProvenance;
    }

    public function getProARangProvenance() {
        return $this->ProARangProvenance;
    }

    public function getProASoucheProvenance() {
        return $this->ProASoucheProvenance;
    }

    public function getProASoucheTheoriqueProvenance() {
        return $this->ProASoucheTheoriqueProvenance;
    }

    public function getProAPaysProvenance() {
        return $this->ProAPaysProvenance;
    }

    public function getProARegionProvenance() {
        return $this->ProARegionProvenance;
    }

    public function getProADepartProvenance() {
        return $this->ProADepartProvenance;
    }

    public function getProACodeIntroProvenanceAnt() {
        return $this->ProACodeIntroProvenanceAnt;
    }

    public function getcaracIdentification() {
        return $this->caracIdentification;
    }

    public function getcaracIdenMorphologique() {
        return $this->caracIdenMorphologique;
    }

    public function getcaracIdenGenetique() {
        return $this->caracIdenGenetique;
    }

    public function getcaracBibliographie() {
        return $this->caracBibliographie;
    }

    public function getcaracIdenAutre() {
        return $this->caracIdenAutre;
    }

    public function getcaracVolume() {
        return $this->caracVolume;
    }

    public function getcaracPage() {
        return $this->caracPage;
    }

    public function getcaracRemarqueAccessionName() {
        return $this->caracRemarqueAccessionName;
    }

    public function getcaracCouleurPe() {
        return $this->caracCouleurPe;
    }

    public function getcaracCouleurPu() {
        return $this->caracCouleurPu;
    }

    public function getcaracSaveur() {
        return $this->caracSaveur;
    }

    public function getcaracPepins() {
        return $this->caracPepins;
    }

    public function getcaracSexe() {
        return $this->caracSexe;
    }

    public function getAgreNumTempCTPS() {
        return $this->AgreNumTempCTPS;
    }

    public function getAgreDelegONIVINS() {
        return $this->AgreDelegONIVINS;
    }

    public function getAgreAgrement() {
        return $this->AgreAgrement;
    }

    public function getAgreDepartAgrementClone() {
        return $this->AgreDepartAgrementClone;
    }

    public function getAgreAnneeAgrement() {
        return $this->AgreAnneeAgrement;
    }

    public function getAgreSiteAgrementClone() {
        return $this->AgreSiteAgrementClone;
    }

    public function getAgreAnneeNonCertifiable() {
        return $this->AgreAnneeNonCertifiable;
    }

    public function getAgreLieuDepotMatInitial() {
        return $this->AgreLieuDepotMatInitial;
    }

    public function getAgreSurfMulti() {
        return $this->AgreSurfMulti;
    }

    public function getAgreNomPartenaire() {
        return $this->AgreNomPartenaire;
    }

    public function getAgreNomPartenaire2() {
        return $this->AgreNomPartenaire2;
    }

    public function getAgreFamilleSanitaire() {
        return $this->AgreFamilleSanitaire;
    }

    public function getAgreAgrementCTPS() {
        return $this->AgreAgrementCTPS;
    }

    public function getAgreNumCloneCTPS() {
        return $this->AgreNumCloneCTPS;
    }

    public function getremarquesMaintienEnCollection() {
        return $this->remarquesMaintienEnCollection;
    }

    public function getremarquesRestrictionDiffusion() {
        return $this->remarquesRestrictionDiffusion;
    }

    public function getremarquesremarquesIntro() {
        return $this->remarquesremarquesIntro;
    }
    ...
    function getFichePDFAccession() {
        ...
        $contents['Collecteur'] = $this->getProDCollecteur();
        $contents['TypeCollecteur'] = $this->getProDTypeCollecteur();
        $contents['ContinentProvenance'] = $this->getProDcontientProvenance();
        $contents['CommuneProvenance'] = $this->getProDCommuneProvenance();
        $contents['CodPostProvenance'] = $this->getProDCodPostProvenance();
        $contents['SiteProvenance'] = $this->getProDSiteProvenance();
        $contents['AdressProvenance'] = $this->getProDAdresProvenance();
        $contents['ProprietProvenance'] = $this->getProDProprietProvenance();
        $contents['ParcelleProvenance'] = $this->getProDParcelleProvenance();
        $contents['TypeParcelleProvenance'] = $this->getProDTypeParcelleProvenance();
        $contents['RangProvenance'] = $this->getProDRangProvenance();
        $contents['SoucheProvenance'] = $this->getProDSoucheProvenance();
        $contents['SoucheTheoriqueProvenance'] = $this->getProDSoucheTheoriqueProvenance();
        $contents['PaysProvenance'] = $this->getProDPaysProvenance();
        $contents['RegionProvenance'] = $this->getProDRegionProvenance();
        $contents['DepartProvenance'] = $this->getProDDepartProvenance();
        $contents['Latitude'] = $this->getProDLatitude();
        $contents['Longitude'] = $this->getProDLongitude();
        $contents['Altitude'] = $this->getProDAltitude();
        $contents['Jour'] = $this->getProDJour();
        $contents['Mois'] = $this->getProDMois();
        $contents['Annee'] = $this->getProDAnnee();
        $contents['CodeIntroPorvenance'] = $this->getProDCodeIntroPorvenance();
        $contents['CodeEntree'] = $this->getProDCodeEntree();
        $contents['ReIntroduit'] = $this->getProDReIntroduit();
        $contents['IssuTraitement'] = $this->getProDIssuTraitement();
        $contents['CloneTraite'] = $this->getProDColoneTraite();
        $contents['RemarquesProvenance'] = $this->getProDRemarquesProvenance();

        $contents['CollecteurAnt'] = $this->getProACollecteur();
        $contents['TypeCollecteur'] = $this->getProATypeCollecteur();
        $contents['ContinentAnt'] = $this->getProAContinentProvenance();
        $contents['CommuneAnt'] = $this->getProACommuneProvenance();
        $contents['CodPostAnt'] = $this->getProACodPostProvenance();
        $contents['SiteAnt'] = $this->getProASiteProvenance();
        $contents['AdressAnt'] = $this->getProAAdresProvenance();
        $contents['ProprietAnt'] = $this->getProAProprietProvenance();
        $contents['ParcelleAnt'] = $this->getProAParcelleProvenance();
        $contents['TypeParcelleAnt'] = $this->getProATypeParcelleProvenance();
        $contents['RangAnt'] = $this->getProARangProvenance();
        $contents['SoucheAnt'] = $this->getProASoucheProvenance();
        $contents['SoucheTheoriqueAnt'] = $this->getProASoucheTheoriqueProvenance();
        $contents['PaysAnt'] = $this->getProAPaysProvenance();
        $contents['RegionAnt'] = $this->getProARegionProvenance();
        $contents['DepartAnt'] = $this->getProADepartProvenance();
        $contents['CodeIntroProvenanceAnt'] = $this->getProACodeIntroProvenanceAnt();

        $contents['Identification'] = $this->getcaracIdentification();
        $contents['IdenMorphologique'] = $this->getcaracIdenMorphologique();
        $contents['IdenGenetique'] = $this->getcaracIdenGenetique();
        $contents['Bibliographie'] = $this->getcaracBibliographie();
        $contents['IdenAutre'] = $this->getcaracIdenAutre();
        $contents['Volume'] = $this->getcaracVolume();
        $contents['Page'] = $this->getcaracPage();
        $contents['RemarqueAccessionName'] = $this->getcaracRemarqueAccessionName();
        $contents['CouleurPe'] = $this->getcaracCouleurPe();
        $contents['CouleurPu'] = $this->getcaracCouleurPu();
        $contents['Saveur'] = $this->getcaracSaveur();
        $contents['Pepins'] = $this->getcaracPepins();
        $contents['Sexe'] = $this->getcaracSexe();

        $contents['NumTempCTPS'] = $this->getAgreNumTempCTPS();
        $contents['DelegONIVINS'] = $this->getAgreDelegONIVINS();
        $contents['Agrement'] = $this->getAgreAgrement();
        $contents['DepartAgrementClone'] = $this->getAgreDepartAgrementClone();
        $contents['AnneeAgrement'] = $this->getAgreAnneeAgrement();
        $contents['SiteAgrementClone'] = $this->getAgreSiteAgrementClone();
        $contents['AnneeNonCertifiable'] = $this->getAgreAnneeNonCertifiable();
        $contents['LieuDepotMatInitial'] = $this->getAgreLieuDepotMatInitial();
        $contents['SurfMulti'] = $this->getAgreSurfMulti();
        $contents['NomPartenaire'] = $this->getAgreNomPartenaire();
        $contents['NomPartenaire2'] = $this->getAgreNomPartenaire2();
        $contents['FamilleSanitaire'] = $this->getAgreFamilleSanitaire();
        $contents['AgrementCTPS'] = $this->getAgreAgrementCTPS();
        $contents['NumCloneCTPS'] = $this->getAgreNumCloneCTPS();
        
        $contents['MaintientEnCollection'] = $this->getremarquesMaintienEnCollection();
        $contents['RestrictionDiffusion'] = $this->getremarquesRestrictionDiffusion();
        $contents['RemarquesIntro'] = $this->getremarquesremarquesIntro();

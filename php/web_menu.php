...
<div class="welcom">
	...
	<?php
		...
		//s'il exist la connection, il affiche des menu pour partenaire
			echo'
			<li id="welcom_contents"><a id="PagePerson" style="cursor:hand" href="PagePerson.php?l='.$_SESSION['language_Vigne'].'"><span id="site-login-title"></span> '.$_SESSION['nomPersonne'].' '.$_SESSION['prenomPersonne'].'</a></li>

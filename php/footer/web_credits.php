...
<div class="chemin">
	<ul>
	<li><a class="lien_chemin" href="./Home.php" id="chemin_home"></a></li><li><img src="images/breadcrumb-separator.png" alt="prochain" width="6" height="10"/></li><li id="chemin_credits"></li>
	</ul>
</div>
</div>';
}else{

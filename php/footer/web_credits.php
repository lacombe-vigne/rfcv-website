...
<div id="demo5" class="demo">
	<div class="events_item"> 
	  ...
	  <img src="http://bioweb.supagro.inra.fr/collection_vigne2014/images/credits_image1.jpg" width="250" height="165">
	</div>
	<div class="events_item">
	  ...
	  <img src="http://bioweb.supagro.inra.fr/collection_vigne2014/images/credits_image2.jpg" width="250" height="165">  
	</div>
	<div class="events_item">
	  <div class="events_intro fr">
	  ...
	  <img src="http://bioweb.supagro.inra.fr/collection_vigne2014/images/credits_image3.jpg" width="250" height="165">  
	</div>
</div>